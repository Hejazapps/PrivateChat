...
class ReplyChatCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.configureCell(messageType: .received, cornerRadius: 15.0)
    }
    ...
    func configureCell(messageType: PaddingLabel.MessageType?, cornerRadius: CGFloat = 0.0) {
        ...
        lbl.makeChatBubble(cornerRadius: cornerRadius, messageType: .received)
    }
